      ...
      <header className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-6 border-b border-blue-500/20">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-center w-full h-24 bg-gray-800 rounded-lg overflow-hidden border border-blue-500/20">
              {/* Space for the banner */}
              <img src="/dec.png" alt="Banner" className="max-w-full max-h-full object-contain" />
            </div>
          </div>
        </div>
      </header>
